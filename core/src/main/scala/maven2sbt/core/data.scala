...
object GroupId extends (String => GroupId) {
  ...
  implicit val render: Render[GroupId] = Render.render(groupId => groupId.groupId)
}
...
object ArtifactId extends (String => ArtifactId) {
  ...
  implicit val render: Render[ArtifactId] = Render.render(artifactId => artifactId.artifactId)
}
...
object Version extends (String => Version) {
  ...
  implicit val render: Render[Version] = Render.render(version => version.version)
}
...
object ScalaVersion extends (String => ScalaVersion) {
  ...
  implicit val render: Render[ScalaVersion] = Render.render(scalaVersion => scalaVersion.scalaVersion)
}
