...
object GroupId extends (String => GroupId) {
  ...
  implicit val render: Render[GroupId] = Render.namedRender("groupId", groupId => groupId.groupId)
}
...
object ArtifactId extends (String => ArtifactId) {
  ...
  implicit val render: Render[ArtifactId] = Render.namedRender("artifactId", artifactId => artifactId.artifactId)
}
...
object Version extends (String => Version) {
  ...
  implicit val render: Render[Version] = Render.namedRender("version", version => version.version)
}
...
object ScalaVersion extends (String => ScalaVersion) {
  ...
  implicit val render: Render[ScalaVersion] = Render.namedRender("scalaVersion", scalaVersion => scalaVersion.scalaVersion)
}
