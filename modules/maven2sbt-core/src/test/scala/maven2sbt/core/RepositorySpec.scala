  ...
  def testRenderRepository: Property = for {
    ...
    repository.name match {
      ...
      case None =>
        Result
          .failure
          .log(s"RepoName in the Repository generated by Gens.genRepository is None. repository: ${repository.show}")
    }
  }
  ...
  def testRenderRepositoryWithEmptyName: Property = for {
    ...
    repository.id match {
      ...
      case None =>
        Result
          .failure
          .log(s"RepoId in the Repository generated by Gens.genRepository is None. repository: ${repository.show}")
    }
  }
